...
public class DownloadBroadCastReceiver extends BroadcastReceiver {
    ...
    static final String ACTION_INSTALL_COMPLETED = "com.renard.ocr_akk.ACTION_OCR_LANGUAGE_INSTALLED";
    static final String ACTION_INSTALL_FAILED = "com.renard.ocr_akk.ACTION_INSTALL_FAILED";
