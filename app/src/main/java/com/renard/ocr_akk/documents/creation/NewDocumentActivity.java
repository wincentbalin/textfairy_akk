...
import com.renard.ocr_akk.MonitoredActivity;
import com.renard.ocr_akk.R;
import com.renard.ocr_akk.documents.creation.ocr.OCRActivity;
import com.renard.ocr_akk.documents.creation.ocr.OcrPdfActivity;
import com.renard.ocr_akk.documents.viewing.DocumentContentProvider;
import com.renard.ocr_akk.documents.viewing.DocumentContentProvider.Columns;
import com.renard.ocr_akk.documents.viewing.grid.DocumentGridActivity;
import com.renard.ocr_akk.documents.viewing.single.DocumentActivity;
import com.renard.ocr_akk.main_menu.language.OcrLanguageDataStore;
import com.renard.ocr_akk.main_menu.language.OcrLanguageListActivity;
import com.renard.ocr_akk.pdf.Hocr2Pdf;
import com.renard.ocr_akk.pdf.Hocr2Pdf.PDFProgressListener;
import com.renard.ocr_akk.util.AppStorage;
import com.renard.ocr_akk.util.MemoryInfo;
import com.renard.ocr_akk.util.Util;
...
import static com.renard.ocr_akk.documents.viewing.single.DocumentActivity.EXTRA_ACCURACY;
import static com.renard.ocr_akk.documents.viewing.single.DocumentActivity.EXTRA_LANGUAGE;
...
public abstract class NewDocumentActivity extends MonitoredActivity {
    ...
    private static final String DATE_CAMERA_INTENT_STARTED_STATE = "com.renard.ocr_akk.android.photo.TakePhotoActivity.dateCameraIntentStarted";
    public static final String EXTRA_IMAGE_SOURCE = "image_source";
    private static Date dateCameraIntentStarted = null;
    private static final String CAMERA_PIC_URI_STATE = "com.renard.ocr_akk.android.photo.TakePhotoActivity.CAMERA_PIC_URI_STATE";
    private static final String CAMERA_PIC_LOCAL_URI_STATE = "com.renard.ocr_akk.android.photo.TakePhotoActivity.CAMERA_PIC_LOCAL_URI_STATE";
